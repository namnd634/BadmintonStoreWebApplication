...
public partial class AuthenticationContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Category__3214EC073A593B34");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Order__3214EC07349FE612");
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.OrderEmployees)
                ...
                .HasConstraintName("FK__Order__EmployeeI__656C112C");
        });

        modelBuilder.Entity<OrderDetail>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderDet__3214EC0705483772");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Product__3214EC079E8A75C5");
